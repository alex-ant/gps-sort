...
func TestCalculateDistance(t *testing.T) {
	...
	dist1 := calculateDistance(&Record{0, rigaLat, rigaLng, 0}, &Record{0, rotterdamLat, rotterdamLng, 0})
	...
	dist2 := calculateDistance(&Record{0, londonLat, londonLng, 0}, &Record{0, rotterdamLat, rotterdamLng, 0})
